...
const SocialLinks = () => {
    ...
    const YouTubeLink = 'https://www.youtube.com/channel/UC9yIpLOu7Yb9dtpwNMEtjJw'
    return (
        <>
            <a href={FBLink} target="_blank" rel="noreferrer" className="text-secondary hover:text-[#0866ff]">
            ...
            <a href={InstagramLink} target="_blank" rel="noreferrer" className="text-secondary hover:text-[#c900bc]">
                <FaInstagram />
                {/* <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
            ...
            <a href={YouTubeLink} target="_blank" rel="noreferrer" className="text-secondary hover:text-neutral">
                <FaYoutube />
                {/* <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
